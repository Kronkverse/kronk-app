...
public class CreateProposal extends MastodonAPIRequest<Proposal>{
	public CreateProposal(String title, String body){
		super(HttpMethod.POST, "/proposals", Proposal.class);
	...
	private static class ProposalFields{
		public String title;
		public String body;
		public String proposalType="small";
