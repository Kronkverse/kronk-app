...
public class CreateEvent extends MastodonAPIRequest<Event>{
	public CreateEvent(String title, String description, String startTime, String endTime,
			...
			boolean postToFeed){
		super(HttpMethod.POST, "/events", Event.class);
